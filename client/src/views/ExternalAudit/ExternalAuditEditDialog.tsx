...
import AddOrEditWitnessDialog from "./AddOrEditExternalAudit";
import AddOrEditPersonDialog from "./AddOrEditExternalAudit";
...
export default function EditExternalAudit({
  open,
  handleClose,
  defaultValues,
  onSubmit,
