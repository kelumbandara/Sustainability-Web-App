...
export const sampleMaternityRegisterData: MaternityRegister[] = [
  {
    ...
    designation: "Helper",
    department: "Sewing",
    supervisorManager: "Md Mahafuj Islam",
    ...
    rejoiningDate: new Date("2024-10-28"),
    supportProvided: "",
  ...
  },
  {
    ...
    rejoiningDate: new Date("2024-09-21"),
    supportProvided: "Financial Aid",
